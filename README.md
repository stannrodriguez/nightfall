...
- **Realm chips.** In the Doors lens, myths filter by realm — every realm
  holds exactly three doors.
...
| Realm | Doors |
| --- | --- |
| The Sky | The Fall of Icarus (Greek) · Amaterasu and the Cave (Japanese) · How Māui Snared the Sun (Māori) |
| Fire & Ending | Ragnarök (Norse) · The Fifth Sun (Aztec) · The Death of Baldr (Norse) |
...
Seven cultures keep constellations in the sky: Greek, Norse, Japanese, Akan,
Aztec, Māori, and Hindu. New doors are carved with every moon.
...
- Keep realms balanced: three doors per realm, so add stories in realm sets
...
- Each culture owns a region of the canvas (Māori top-left, Norse top-center,
  ...
  bottom-left); place new stars inside their culture's region.
